...
function Card(props) {
    ...
    const {gameImageUrl,gameName,gameSteamRatingText,gameSalePrice,gameRetailPrice} = props.game
    ...
    const savingPercent = parseFloat(props.game.gameSavingPercent).toFixed(2)
    return (
